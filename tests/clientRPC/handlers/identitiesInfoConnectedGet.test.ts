...
import type { RPCResponseResult } from '@/clientRPC/types';
import type { IdentityInfoMessage } from '@/clientRPC/handlers/types';
...
} from '@/clientRPC/handlers/identitiesInfoConnectedGet';
