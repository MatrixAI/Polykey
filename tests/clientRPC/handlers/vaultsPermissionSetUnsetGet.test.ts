...
import type { VaultPermissionMessage } from '@/clientRPC/handlers/types';
...
} from '@/clientRPC/handlers/vaultsPermissionSet';
import {
  vaultsPermissionGet,
  VaultsPermissionGetHandler,
} from '@/clientRPC/handlers/vaultsPermissionGet';
import {
  vaultsPermissionUnset,
  VaultsPermissionUnsetHandler,
} from '@/clientRPC/handlers/vaultsPermissionUnset';
