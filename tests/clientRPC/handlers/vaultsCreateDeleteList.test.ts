...
import type { VaultListMessage } from '@/clientRPC/handlers/types';
import fs from 'fs';
...
import {
  vaultsCreate,
  VaultsCreatehandler,
} from '@/clientRPC/handlers/vaultsCreate';
import {
  vaultsDelete,
  VaultsDeleteHandler,
} from '@/clientRPC/handlers/vaultsDelete';
import { vaultsList, VaultsListHandler } from '@/clientRPC/handlers/vaultsList';
