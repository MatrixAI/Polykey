  ...
  describe('Vaults', () => {
    ...
    describe('Version', () => {
      ...
      test('should fail to find a non existent version', async () => {
        // Revert the version
        const vaultMessage = new vaultsPB.Vault();
        vaultMessage.setNameOrId(vaultsUtils.makeVaultIdPretty(vaultId));
        const vaultVersionMessage = new vaultsPB.Version();
        vaultVersionMessage.setVault(vaultMessage);
    ...
    test('should get vault permissions', async () => {
      ...
      try {
        ...
        await remoteKeynode1.acl.setNodePerm(pkAgent.nodeManager.getNodeId(), {
          gestalt: {
            notify: null,
          },
          vaults: {},
        });
        await remoteKeynode2.acl.setNodePerm(pkAgent.nodeManager.getNodeId(), {
          gestalt: {
            notify: null,
          },
          vaults: {},
        ...
        vaultMessage.setNameOrId(vaultsUtils.makeVaultIdPretty(vaultId2));
