...
describe('CLI secrets', () => {
  ...
  describe('commandDeleteSecret', () => {
    testIf(isTestPlatformEmpty)('should delete secrets', async () => {
  ...
  describe('commandGetSecret', () => {
    testIf(isTestPlatformEmpty)('should retrieve secrets', async () => {
  ...
  describe('commandNewDir', () => {
    testIf(isTestPlatformEmpty)('should make a directory', async () => {
  ...
  describe('commandRenameSecret', () => {
    testIf(isTestPlatformEmpty)('should rename secrets', async () => {
  ...
  describe('commandUpdateSecret', () => {
    testIf(isTestPlatformEmpty)('should update secrets', async () => {
