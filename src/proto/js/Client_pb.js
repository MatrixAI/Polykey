...
goog.exportSymbol('proto.clientInterface.DirectoryMessage', null, global);
 ...
 * @constructor
 */
proto.clientInterface.DirectoryMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.clientInterface.DirectoryMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.clientInterface.DirectoryMessage.displayName = 'proto.clientInterface.DirectoryMessage';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.clientInterface.DirectoryMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.clientInterface.DirectoryMessage.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.clientInterface.DirectoryMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.clientInterface.DirectoryMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.clientInterface.DirectoryMessage}
 */
proto.clientInterface.DirectoryMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.clientInterface.DirectoryMessage;
  return proto.clientInterface.DirectoryMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.clientInterface.DirectoryMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.clientInterface.DirectoryMessage}
 */
proto.clientInterface.DirectoryMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.clientInterface.DirectoryMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.clientInterface.DirectoryMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.clientInterface.DirectoryMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.clientInterface.DirectoryMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDir();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.clientInterface.DirectoryMessage.prototype.getDir = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.clientInterface.DirectoryMessage} returns this
 */
proto.clientInterface.DirectoryMessage.prototype.setDir = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
