...
interface IAgentServiceService_INodesChainDataGet extends grpc.MethodDefinition<polykey_v1_nodes_nodes_pb.ClaimId, polykey_v1_nodes_nodes_pb.AgentClaim> {
    path: "/polykey.v1.AgentService/NodesChainDataGet";
    requestStream: false;
    responseStream: true;
    requestSerialize: grpc.serialize<polykey_v1_nodes_nodes_pb.ClaimId>;
    requestDeserialize: grpc.deserialize<polykey_v1_nodes_nodes_pb.ClaimId>;
    responseSerialize: grpc.serialize<polykey_v1_nodes_nodes_pb.AgentClaim>;
    responseDeserialize: grpc.deserialize<polykey_v1_nodes_nodes_pb.AgentClaim>;
}
...
interface IAgentServiceService_INodesCrossSignClaim extends grpc.MethodDefinition<polykey_v1_nodes_nodes_pb.AgentClaim, polykey_v1_nodes_nodes_pb.AgentClaim> {
    path: "/polykey.v1.AgentService/NodesCrossSignClaim";
    requestStream: true;
    responseStream: true;
    requestSerialize: grpc.serialize<polykey_v1_nodes_nodes_pb.AgentClaim>;
    requestDeserialize: grpc.deserialize<polykey_v1_nodes_nodes_pb.AgentClaim>;
    responseSerialize: grpc.serialize<polykey_v1_nodes_nodes_pb.AgentClaim>;
    responseDeserialize: grpc.deserialize<polykey_v1_nodes_nodes_pb.AgentClaim>;
}
...
export interface IAgentServiceServer extends grpc.UntypedServiceImplementation {
    ...
    nodesChainDataGet: grpc.handleServerStreamingCall<polykey_v1_nodes_nodes_pb.ClaimId, polykey_v1_nodes_nodes_pb.AgentClaim>;
    nodesHolePunchMessageSend: grpc.handleUnaryCall<polykey_v1_nodes_nodes_pb.Relay, polykey_v1_utils_utils_pb.EmptyMessage>;
    nodesCrossSignClaim: grpc.handleBidiStreamingCall<polykey_v1_nodes_nodes_pb.AgentClaim, polykey_v1_nodes_nodes_pb.AgentClaim>;
...
export interface IAgentServiceClient {
    ...
    nodesChainDataGet(request: polykey_v1_nodes_nodes_pb.ClaimId, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<polykey_v1_nodes_nodes_pb.AgentClaim>;
    nodesChainDataGet(request: polykey_v1_nodes_nodes_pb.ClaimId, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<polykey_v1_nodes_nodes_pb.AgentClaim>;
    ...
    nodesCrossSignClaim(): grpc.ClientDuplexStream<polykey_v1_nodes_nodes_pb.AgentClaim, polykey_v1_nodes_nodes_pb.AgentClaim>;
    nodesCrossSignClaim(options: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<polykey_v1_nodes_nodes_pb.AgentClaim, polykey_v1_nodes_nodes_pb.AgentClaim>;
    nodesCrossSignClaim(metadata: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<polykey_v1_nodes_nodes_pb.AgentClaim, polykey_v1_nodes_nodes_pb.AgentClaim>;
...
export class AgentServiceClient extends grpc.Client implements IAgentServiceClient {
    ...
    public nodesChainDataGet(request: polykey_v1_nodes_nodes_pb.ClaimId, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<polykey_v1_nodes_nodes_pb.AgentClaim>;
    public nodesChainDataGet(request: polykey_v1_nodes_nodes_pb.ClaimId, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<polykey_v1_nodes_nodes_pb.AgentClaim>;
    ...
    public nodesCrossSignClaim(options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<polykey_v1_nodes_nodes_pb.AgentClaim, polykey_v1_nodes_nodes_pb.AgentClaim>;
    public nodesCrossSignClaim(metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<polykey_v1_nodes_nodes_pb.AgentClaim, polykey_v1_nodes_nodes_pb.AgentClaim>;
