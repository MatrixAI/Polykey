...
let
  sources = {
    ...
    "xstate-4.15.1" = {
      ...
      version = "4.15.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/xstate/-/xstate-4.15.1.tgz";
        sha512 = "8dD/GnTwxUuDr/cY42vi+Enu4mpbuUXWISYJ0a9BC+cIFvqufJsepyDLS6lLsznfUP0GS5Yx9m3IQWFhAoGt/A==";
      };
    };
    "xtend-4.0.1" = {
      name = "xtend";
