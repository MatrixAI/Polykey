...
goog.exportSymbol('proto.agentInterface.DIProofMessage', null, global);
 ...
 * @constructor
 */
proto.agentInterface.DIProofMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.agentInterface.DIProofMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.agentInterface.DIProofMessage.displayName = 'proto.agentInterface.DIProofMessage';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.agentInterface.DIProofMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.agentInterface.DIProofMessage.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.agentInterface.DIProofMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.agentInterface.DIProofMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    digitalIdentityLink: jspb.Message.getFieldWithDefault(msg, 1, ""),
    proofLink: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.agentInterface.DIProofMessage}
 */
proto.agentInterface.DIProofMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.agentInterface.DIProofMessage;
  return proto.agentInterface.DIProofMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.agentInterface.DIProofMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.agentInterface.DIProofMessage}
 */
proto.agentInterface.DIProofMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setDigitalIdentityLink(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setProofLink(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.agentInterface.DIProofMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.agentInterface.DIProofMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.agentInterface.DIProofMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.agentInterface.DIProofMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDigitalIdentityLink();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string digital_identity_link = 1;
 * @return {string}
 */
proto.agentInterface.DIProofMessage.prototype.getDigitalIdentityLink = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.agentInterface.DIProofMessage} returns this
 */
proto.agentInterface.DIProofMessage.prototype.setDigitalIdentityLink = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string proof_link = 2;
 * @return {string}
 */
proto.agentInterface.DIProofMessage.prototype.getProofLink = function() {
 ...
 * @return {!proto.agentInterface.DIProofMessage} returns this
 */
proto.agentInterface.DIProofMessage.prototype.setProofLink = function(value) {
...
proto.agentInterface.PeerInfoMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proofListList: jspb.Message.toObjectList(msg.getProofListList(),
    proto.agentInterface.DIProofMessage.toObject, includeInstance),
...
proto.agentInterface.PeerInfoMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.agentInterface.DIProofMessage;
      reader.readMessage(value,proto.agentInterface.DIProofMessage.deserializeBinaryFromReader);
      msg.addProofList(value);
      break;
    case 8:
      var value = /** @type {string} */ (reader.readString());
      msg.setPem(value);
...
proto.agentInterface.PeerInfoMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getProofListList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      7,
      f,
      proto.agentInterface.DIProofMessage.serializeBinaryToWriter
    );
  }
  f = message.getPem();
  if (f.length > 0) {
...
/**
 * repeated DIProofMessage proof_list = 7;
 * @return {!Array<!proto.agentInterface.DIProofMessage>}
 */
proto.agentInterface.PeerInfoMessage.prototype.getProofListList = function() {
  return /** @type{!Array<!proto.agentInterface.DIProofMessage>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.agentInterface.DIProofMessage, 7));
};


/**
 * @param {!Array<!proto.agentInterface.DIProofMessage>} value
 * @return {!proto.agentInterface.PeerInfoMessage} returns this
*/
proto.agentInterface.PeerInfoMessage.prototype.setProofListList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 7, value);
};


/**
 * @param {!proto.agentInterface.DIProofMessage=} opt_value
 * @param {number=} opt_index
 * @return {!proto.agentInterface.DIProofMessage}
 */
proto.agentInterface.PeerInfoMessage.prototype.addProofList = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.agentInterface.DIProofMessage, opt_index);
};
 ...
 * @return {!proto.agentInterface.PeerInfoMessage} returns this
 */
proto.agentInterface.PeerInfoMessage.prototype.clearProofListList = function() {
  return this.setProofListList([]);
};
